...
describe BasketParser do
  ...
  it "can parse the first example basket" do
    items = described_class.parse_data(basket_data('input1.csv'))
  ...
  it "can parse the second example basket" do
    items = described_class.parse_data(basket_data('input2.csv'))
  ...
  it "can parse the third example basket" do
    items = described_class.parse_data(basket_data('input3.csv'))
